    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-x-0 top-0 z-0 flex justify-center pointer-events-none select-none overflow-visible section-body-gapp">
                <h2 className="w-full text-center text-[15vw] xl:text-[16vw] font-black text-[#f4f4f4] tracking-[-0.03em] uppercase font-schein leading-none select-none">
                    OUR RANGE
                </h2>
            </div>
            ...
            >
                {items.map((item, index) => {
                    ...
                    if (index === activeIndex) {
                        isActive = true;
                        positionClass = "left-1/2 -translate-x-1/2 z-30 scale-125 md:scale-140 blur-none opacity-100";
                    } else if (
                        index === (activeIndex - 1 + items.length) % items.length
                    ) {
                        // Left item positioned to bleed off the left screen edge
                        positionClass = "left-[-2%] sm:left-[8%] md:left-[12%] lg:left-[15%] xl:left-[18%] -translate-x-1/2 z-10 scale-[0.68] md:scale-[0.75] blur-[7px] hover:blur-none opacity-40 hover:opacity-100 cursor-pointer";
                    } else {
                        // Right item positioned to bleed off the right screen edge
                        positionClass = "left-[102%] sm:left-[92%] md:left-[88%] lg:left-[85%] xl:left-[82%] -translate-x-1/2 z-10 scale-[0.68] md:scale-[0.75] blur-[7px] hover:blur-none opacity-40 hover:opacity-100 cursor-pointer";
                    }
